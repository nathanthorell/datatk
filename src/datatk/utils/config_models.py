...
class DatatkGlobalConfig(BaseModel):
    """Global datatk configuration that applies to all tools."""
...
class ProcTesterConfig(SimpleToolConfig):
    """Configuration for the proc_tester tool."""
...
class ExportParquetObject(BaseModel):
    """A single object to export in export_parquet."""
...
class ExportParquetConfig(BaseModel):
    """Configuration for the export_parquet tool."""

    conn: str
    database: str | None = None
    data_dir: str = "./data/"
    batch_size: int = 10000
    objects: list[ExportParquetObject]
    logging_level: Literal["verbose", "summary", "errors_only"] | None = None
...
CONFIG_MODELS: dict[str, type[BaseModel]] = {
    ...
    "proc_tester": ProcTesterConfig,
    "view_tester": ViewTesterConfig,
    "export_parquet": ExportParquetConfig,
